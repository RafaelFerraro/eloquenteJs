...
function BeanCounting() {
  this.countBs = function(string, letter) {
    var regex = new RegExp(letter, "g");
    var times = string.match(regex);

    return "The " + letter + " has found " + times.length + " times.";
  };
};

var 
  bean   = new BeanCounting(),
  result = bean.countBs("makingatestWithString", "t");
